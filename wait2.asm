...
int main()
{
  ...
  21:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  24:	50                   	push   %eax
  25:	8d 45 e0             	lea    -0x20(%ebp),%eax
  28:	50                   	push   %eax
  29:	8d 45 dc             	lea    -0x24(%ebp),%eax
  2c:	50                   	push   %eax
  2d:	e8 79 03 00 00       	call   3ab <wait2>
  ...
  3c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  3f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  42:	8b 7d dc             	mov    -0x24(%ebp),%edi
  45:	89 4d d0             	mov    %ecx,-0x30(%ebp)
  48:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  4b:	e8 23 03 00 00       	call   373 <getpid>
  50:	8b 4d d0             	mov    -0x30(%ebp),%ecx
  53:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  ...
  5c:	53                   	push   %ebx
  5d:	50                   	push   %eax
  5e:	68 c0 07 00 00       	push   $0x7c0
  63:	6a 01                	push   $0x1
  65:	e8 06 04 00 00       	call   470 <printf>
  6a:	83 c4 20             	add    $0x20,%esp
    while (i < 2) // loop executes twice
  6d:	83 fe 01             	cmp    $0x1,%esi
  70:	75 0e                	jne    80 <main+0x80>
    }
    exit();
  ...
  85:	eb 92                	jmp    19 <main+0x19>
            printf(1, "No terminated child found for pid = %d\n", getpid());
  87:	e8 e7 02 00 00       	call   373 <getpid>
  8c:	52                   	push   %edx
  8d:	50                   	push   %eax
  8e:	68 98 07 00 00       	push   $0x798
  93:	6a 01                	push   $0x1
  95:	e8 d6 03 00 00       	call   470 <printf>
  9a:	83 c4 10             	add    $0x10,%esp
  9d:	eb ce                	jmp    6d <main+0x6d>
  9f:	90                   	nop
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 1c 08 00 00 	jmp    *0x81c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 13 08 00 00       	mov    $0x813,%edx
        while(*s != 0){
