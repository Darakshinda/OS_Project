...
void forkrun() {
  ...
  83:	83 ec 08             	sub    $0x8,%esp
	int fr = fork();
  86:	e8 90 02 00 00       	call   31b <fork>
	if (fr == -1) {
  8b:	83 f8 ff             	cmp    $0xffffffff,%eax
  8e:	74 10                	je     a0 <forkrun+0x20>
	} else if (fr == 0) {
  90:	85 c0                	test   %eax,%eax
  92:	74 20                	je     b4 <forkrun+0x34>
}
  94:	c9                   	leave  
		wait();
  95:	e9 91 02 00 00       	jmp    32b <wait>
  9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		printf(1, "Fork error!\n");
  a0:	83 ec 08             	sub    $0x8,%esp
  a3:	68 c8 07 00 00       	push   $0x7c8
  a8:	6a 01                	push   $0x1
  ...
  b5:	50                   	push   %eax
  b6:	6a 00                	push   $0x0
  b8:	68 d5 07 00 00       	push   $0x7d5
  bd:	e8 a1 02 00 00       	call   363 <open>
  c2:	89 04 24             	mov    %eax,(%esp)
  c5:	e8 81 02 00 00       	call   34b <close>
		exit();
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 34 08 00 00       	mov    $0x834,%edx
        while(*s != 0){
